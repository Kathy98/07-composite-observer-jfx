...
public class MainController implements Initializable {
	...
	// ToDo: Modify the controller so that it has an attribute of type ObservableList
	//  	 as well as attributes for the close button and vegetarian checkbox.
	...
	// the interface name suggests that the list of observed by the list view,
	// i.e. changes in the data structure should be reflected in the GUI.
	@FXML
